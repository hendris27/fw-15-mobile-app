      ...
      <View style={style.itemWrapperStyle}>
        <View style={style.photosContent}>
          <View style={style.photoIcons}>
            <ImageTemplate src={item?.picture || null} defaultImg={IMGEventDummy} style={style.IMGProfiles} />
          </View>
        </View>
        <View style={style.contentWrapperStyle}>
          ...
          <Text style={style.txtEmailStyle}>Location : {`${item?.location} `}</Text>
          <Text style={style.txtEmailStyle}>Category : {`${item?.category} `}</Text>
        ...
        <View style={style.centeredView}>
          <View style={style.modalView}>
            ...
            <View style={style.wrapModalBtn}>
              <Pressable style={[style.button, style.buttonOpen]} onPress={() => setModalVisible(!modalVisible)}>
